...
class BannerHelper
{
    public static function loadBlockList(): array
    {
        return [
            ...
            4 => 'Банер номер 1 на странице слотов, после тринадцатого слота (1)',
            5 => 'Банер номер 2 на странице слотов, после тринадцатого слота (1)',
            6 => 'Банер номер 2 на странице слотов, после тринадцатого слота (1)',
            7 => 'Банер номер 4 на странице слотов, после тринадцатого слота (1)',
        ];
    }
