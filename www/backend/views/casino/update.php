...
/* @var $model \backend\forms\UpdateUrlForm */
/* @var $casino \common\models\Casino */

$this->title = 'Update Casino: ' . $casino->title;
$this->params['breadcrumbs'][] = ['label' => 'Casinos', 'url' => ['index']];
$this->params['breadcrumbs'][] = ['label' => $casino->title, 'url' => ['view', 'id' => $model->id]];
